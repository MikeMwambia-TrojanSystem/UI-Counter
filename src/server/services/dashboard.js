/**
 * Server-only. Dashboard CRUD against the backend API.
 */
const { validCreate, updateCheck } = require("../validation/dashboardSchema.js");
const axios = require("axios");
const config = require("../config/env.js");

const baseURL = `${config.apiBaseUrl}/dashboard`;
...
exports.updateDashboard = async function (_url, _data) {
  ...
  if (valid === true) {
    let _response = false;
    const _Ddata = JSON.parse(JSON.stringify(_data));
